    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex md:items-center md:space-x-6">
                ...
                <a href="index.html#services" data-page="index.html" data-anchor="#services" class="nav-link text-gray-500 font-medium hover:text-indigo-600 transition duration-150 relative group">Dịch vụ <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-indigo-600 transition-all duration-300 group-hover:w-full"></span></a>
