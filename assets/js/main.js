    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex md:items-center md:space-x-8">
                ...
                <a href="index.html#contact" class="ml-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-transform hover:scale-105">
                    Liên hệ ngay
                </a>
            </div>
...
function injectHeaderAndSetCurrentLink() {
    ...
    links.forEach(link => {
        ...
        // Logic cho trang con (projects.html, hosting.html, domain.html, bao-gia.html)
